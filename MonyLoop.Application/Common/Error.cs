...
namespace MonyLoop.Application.Common
{
	public class Error
	{
		...
		public static Error Unauthorized(String code = "General.Unauthorized", String description = "You Are Not Authorized To .....")
		{
		...
		public static Error InvalidCrendentials(String code = "General.InvalidCrendentials", String description = "General Failure Has Occured")
		{
