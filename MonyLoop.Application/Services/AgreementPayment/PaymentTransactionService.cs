...
namespace MonyLoop.Application.Services.AgreementPayment
{
    public class PaymentTransactionService : IPaymentTransactionService
    {
        ...
        public async Task<PaymentTransactionResponse> RecordPayInAsync(
            RecordPayInRequest request)
        {
            ...
            await _memberLedgerRepository
                .GetByIdWithSlotAsync(request.MemberLedgerId);
            ...
            var paymentTransaction = new PaymentTransaction
            {
                ...
                // For now we keep it Pending.
                // Later we can decide whether simulated payments
            ...
            return _mapper.Map<PaymentTransactionResponse>(
                paymentTransaction);
        }
        public async Task<PaymentTransactionResponse> RecordPayOutAsync(
    RecordPayOutRequest request)
            ...
            Guid transactionId)
        {
            ...
            return _mapper.Map<PaymentReceiptResponse>(
                transaction);
        }
